...
const VerticalMenu = ({ scrollMenu }: Props) => {
  ...
  const { allShops, currentShopData } = useEssentialDataStore()
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* {ToDo: add a alert point if the store timing is not updated} */}
        <MenuItem
        ...
        <MenuItem href={`/${locale}/addstore`} icon={<i className='tabler-building-store' />}>
          {'Add Store'}
        </MenuItem>
        ...
        <MenuItem href={`/${locale}/privacypolicy`} icon={<i className='tabler-file-description' />}>
          {'Privacy Policy'}
        </MenuItem>
        <br />
        <Button
