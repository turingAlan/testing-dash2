...
type EmailFormData = Input<typeof emailSchema>
type PhoneFormData = Input<typeof phoneSchema>
...
const emailSchema = object({
  ...
  password: string([minLength(6, "Password isn't valid"), regex(passwordRegex, "password isn't valid")])
})
