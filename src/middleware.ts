...
export default withAuth(
  async function middleware(request: NextRequestWithAuth) {
    ...
    const token =
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiMzlmYzlkMDYtMjE4Zi00MDlkLWFhZWMtN2MzOWRkNmUyNzRmIiwib3JnX2lkIjoiMTRlNzllZjgtMjFlNy00NDVjLWExMmYtMTBmNzAwNTM1MDgzIiwiZXhwIjoxNzMxMzY0NTg1LCJpYXQiOjE3MzA3NTk3ODV9.LzbgFU4YT_uNo6mtIQNn49sv4Qwif-zAo2jeFOrFvck'
